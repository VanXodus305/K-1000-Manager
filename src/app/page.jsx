...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen bg-[#091F2A] px-4 sm:px-6 md:px-10 py-6 overflow-y-hidden">
      ...
      <section className="flex flex-col md:flex-row justify-center items-center text-center md:text-left py-4 px-2 sm:px-6 md:px-10 m-4 sm:m-6 gap-10 md:gap-14">
        ...
        <div className="flex flex-col justify-center items-center md:items-start space-y-4">
          ...
          <h2 className="font-medium text-3xl sm:text-4xl md:text-5xl text-white">
            Manager Project
          </h2>
        </div>
      </section>
      ...
      <section className="flex justify-center px-4 sm:px-8 md:px-12">
        <p className="text-center text-gray-400 text-base sm:text-lg leading-relaxed italic max-w-3xl">
          ...
          Aenean in lorem vel sapien tincidunt sagittis ut et lectus. Proin sit amet 
          eros vitae justo tincidunt fermentum vitae sed nisi.
        </p>
      </section>

      {/* Team Section */}
      <div className="min-h-screen bg-[#091F2A] py-16 px-4">
      ...
      {/* Footer */}
      <footer className="bg-gradient-to-b from-[#091F2A] via-[#0E2F3F] to-[#274F62] text-white py-8">

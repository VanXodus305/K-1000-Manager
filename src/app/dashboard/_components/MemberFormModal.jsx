...
export default function MemberFormModal({
  ...
  React.useEffect(() => {
    if (member) {
      // Convert birthday to ISO string if it exists to avoid serialization issues
      const memberData = {
        ...member,
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="grid grid-cols-1 gap-4">
                <DatePicker
                  ...
                  onChange={(date) => {
                    if (date) {
                      // Create ISO string directly to avoid timezone issues
                  ...
                  classNames={{
                    ...
                    segment: "data-[editable=true]:bg-transparent text-primary",
